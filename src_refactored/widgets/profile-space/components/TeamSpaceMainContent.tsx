// 01）团队空间 Tab 主体内容（TeamSpaceMainContent）
...
import {
  useTeamAchievementsTabData, useTeamMembersTabData,
  useTeamNotesTabData, useTeamProjectsTabData,
} from '../hooks/useTeamTabData'
import { AchievementsTabContent } from './tabs/AchievementsTabContent'
import { TeamHomeTabContent } from './tabs/TeamHomeTabContent'
...
// 02）团队空间 Tab 主体内容 Props（TeamSpaceMainContentProps）
interface TeamSpaceMainContentProps {
  model: TeamSpaceWidgetModel
}

// 03）团队空间 Tab 主体内容（TeamSpaceMainContent）
/**
 * 函数名：TeamSpaceMainContent
 ...
 * - 副作用：按 Tab 发起网络请求
 */
export function TeamSpaceMainContent({ model }: TeamSpaceMainContentProps) {
