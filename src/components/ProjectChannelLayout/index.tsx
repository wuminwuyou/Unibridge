 ...
 * 使用方页面：
 * - apps/web-client/src/pages/HomePage（首页·默认项目频道，传入 experienceRecommendedNotes 显示经验推荐区）
 * - apps/web-client/src/pages/CampusRecruitPage（高校招募频道，右侧栏改为推荐本校实验室）
 * - apps/web-client/src/pages/EnterprisePracticePage（企业实战频道，右侧栏为推荐企业）
 * 实现方法：
