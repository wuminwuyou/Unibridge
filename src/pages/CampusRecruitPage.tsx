...
const campusRecruitProjects: ProjectItem[] = [
  {
...
const recommendedTypes: string[] = ['实验室项目', '科研训练', '大模型应用', '机器人开发', '校园平台', 'Python', '工程实践', '竞赛孵化']

// 03）推荐本校实验室数据（recommendedLabs）
const recommendedLabs: RecommendedCompany[] = [
...
// 05）高校招募页面组件（CampusRecruitPage）
/**
 * 函数名：CampusRecruitPage
 * 功能：渲染高校招募频道页面，展示实验室项目与招新信息。
 * 实现方法：
 * - 复用 ProjectZonePageLayout 继承首页的项目流与侧栏布局
 * - 注入高校项目数据，突出实验室发布与招新属性
...
function CampusRecruitPage() {
  return (
    <ProjectZonePageLayout
      ...
      recommendedOrganizations={recommendedLabs}
