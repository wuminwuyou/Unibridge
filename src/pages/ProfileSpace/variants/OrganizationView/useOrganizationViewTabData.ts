...
import {
  ...
  getEntityProfileHome,
  getEntityProfileMembers,
  getEntityProfileNotes,
  getEntityProfileProjects,
  getEntityProfileTeams,
...
import { mapEntityProfileMembers, mapEntityProfileTeams } from './mapEntityProfileSpaceData'
import type { OrganizationMemberItem, OrganizationTeamItem } from './types'
import type { ProjectItem } from '../../../../types/project'
import type { ProfileNoteItem } from '../../components/types'

// 01）解析 Tab 加载错误文案（resolveOrganizationTabErrorMessage）
...
// 02）机构主页 Tab 数据 Hook（useOrganizationHomeTabData）
/**
...
// 03）机构实验室 Tab 数据 Hook（useOrganizationLabsTabData）
...
// 05）机构笔记 Tab 数据 Hook（useOrganizationNotesTabData）
...
// 06）机构人员 Tab 数据 Hook（useOrganizationMembersTabData）
/**
