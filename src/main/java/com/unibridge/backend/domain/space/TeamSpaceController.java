...
public class TeamSpaceController {
    ...
    public Result getTeamProfileSpace(
        ...
        return Result.success(teamSpaceService.getTeamProfileSpace(authorization, teamUid));
    }
    ...
    public Result getTeamProfileMembers(
        ...
        return Result.success(teamSpaceService.getTeamProfileMembers(authorization, teamUid, page, pageSize));
    }
    ...
    public Result syncTeamProfileMembers(
        ...
        return Result.success(teamSpaceService.syncTeamMembers(authorization, teamUid, request));
    }
