...
public class SpaceController {
    ...
    public Result getProfileSpace(
        ...
        return Result.success(spaceService.getProfileSpace(authorization, uid, userUid, userId, request));
    }
    ...
    public Result getProfileHome(
        ...
        return Result.success(spaceService.getProfileHome(authorization, uid, userUid, userId, projectLimit, noteLimit));
    }
    ...
    public Result getProfileProjects(
        ...
        return Result.success(spaceService.getProfileProjects(authorization, uid, userUid, userId, page, pageSize));
    }
    ...
    public Result getProfileNotes(
        ...
        return Result.success(spaceService.getProfileNotes(authorization, uid, userUid, userId, page, pageSize, contentType));
    }
}
